...
<Project Type="Project" LVVersion="17008000">
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="JsonTest.lvclass" Type="LVClass" URL="../Tests/JsonTest/JsonTest/JsonTest.lvclass"/>
		<Item Name="Variant JSON API.lvlib" Type="Library" URL="../Source/Variant JSON API.lvlib"/>
		<Item Name="Variant JSON API.vipb" Type="Document" URL="../Variant JSON API.vipb"/>
